...
var bounceMap = map[byte]map[direction][]bounce{
	...
	'.': {
		...
		south: []bounce{{-1, 0, south}},
		west:  []bounce{{0, 1, west}},
	},
	'/': {
		north: []bounce{{0, -1, east}},
		east:  []bounce{{1, 0, north}},
		south: []bounce{{0, 1, west}},
		west:  []bounce{{-1, 0, south}},
	},
	'\\': {
		north: []bounce{{0, 1, west}},
		east:  []bounce{{-1, 0, south}},
		south: []bounce{{0, -1, east}},
		west:  []bounce{{1, 0, north}},
	},
	'|': {
		north: []bounce{{1, 0, north}},
		east:  []bounce{{1, 0, north}, {-1, 0, south}},
		south: []bounce{{-1, 0, south}},
		west:  []bounce{{1, 0, north}, {-1, 0, south}},
	},
	'-': {
		north: []bounce{{0, -1, east}, {0, 1, west}},
		east:  []bounce{{0, -1, east}},
		south: []bounce{{0, -1, east}, {0, 1, west}},
		west:  []bounce{{0, 1, west}},
	},
}
